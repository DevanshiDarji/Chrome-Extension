...
if($_REQUEST['method'] == 'validate') {
    VIGsyncGmailOutfittersLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    VIGsyncGmailOutfittersLicense::change();
} else if($_REQUEST['method'] == 'add') {
    VIGsyncGmailOutfittersLicense::add();
    ...
    $validate_license = VIGsyncGmailOutfittersLicense::isValid($currentModule,$user_id,true);
