...
/*
    ...
    public function display()
    {
        ...
        require_once('modules/'.$currentModule.'/license/VIGsyncGmailOutfittersLicense.php');
        ...
        $key = VIGsyncGmailOutfittersLicense::getKey($currentModule);
        if(!empty($key)) {
        ...
        if(isset($outfitters_config['manage_licensed_users']) && $outfitters_config['manage_licensed_users'] == true) {
            ...
            if(!empty($trimmed_last))
            {
                ...
                $validated = VIGsyncGmailOutfittersLicense::doValidate($currentModule);
                $store = array(
                    'last_ran' => time(),
        ...
        $this->ss->display('modules/VIGsyncGmailLicenseAddon/tpls/license.tpl');
    }//end of display
