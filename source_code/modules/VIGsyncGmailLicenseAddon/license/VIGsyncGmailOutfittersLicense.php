...
if(!class_exists('VIGsyncGmailOutfittersLicense')) {
    class VIGsyncGmailOutfittersLicense{
        ...
        public static function isValid($thisModule=null,$user_id=null,$force_validation=false) {
            ...
            $validated = VIGsyncGmailOutfittersLicense::doValidate($thisModule);
        ...
        public static function getKey($thisModule=null) {
            ...
            $administration = new Administration();
            $administration->retrieveSettings();
            if(isset($outfitters_config['shortname']) && !empty($outfitters_config['shortname'])){
        ...
        public static function validate() {
            ...
            $validated = VIGsyncGmailOutfittersLicense::doValidate($currentModule,$_REQUEST['key']);
        ...
        public static function doValidate($thisModule,$key=null) {
            ...
            {
                $GLOBALS['log']->fatal('VIGsyncGmailOutfittersLicense::doValidate() failed: '.print_r($response,true));
            }
            return $response;
        ...
        public static function change() {
            ...
            {
                header('HTTP/1.1 400 Bad Request');
                $GLOBALS['log']->fatal('VIGsyncGmailOutfittersLicense::change() failed: '.print_r($response,true));
            } 
            else 
            {
                require_once('modules/Administration/Administration.php');
        ...
        public static function add() {
            ...
            $response = VIGsyncGmailOutfittersLicense::doValidate($currentModule);
    ...
    class SugarOutfitters_API {
        private function get_default_payload($module,$custom_data = array()) {
            ...
            if (empty($custom_data['key'])){
                $key = VIGsyncGmailOutfittersLicense::getKey($module);
